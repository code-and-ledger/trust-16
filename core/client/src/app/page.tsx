...
const Home: React.FC = () => {
  ...
  return (
    <div className="bg-background w-screen h-screen overflow-hidden flex flex-col justify-center items-center relative">
      <div
        className={`absolute top-0 bottom-0 right-1/2 bg-black transition-all duration-100 ease-in-out ${
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        />
        <h1
          className={`text-3xl font-bold mt-4 mb-4 transition-opacity duration-1000 ease-in-out ${
