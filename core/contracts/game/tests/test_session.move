...
module trust_16::test_session {
    ...
    public fun create_session(aptos_framework: &signer, dev: &signer, trust_16: &signer, session_manager: &signer, alice: &signer, bob: &signer, charlie: &signer) {
    ...
    #[test(aptos_framework = @0x1, dev = @dev, trust_16 = @trust_16, session_manager = @session_manager, alice = @0x111, bob = @0x222, charlie = @0x333)]
    public fun start_session(aptos_framework: &signer, dev: &signer, trust_16: &signer, session_manager: &signer, alice: &signer, bob: &signer, charlie: &signer) {
        test_utils::setup_test(aptos_framework, dev, trust_16, session_manager, alice, bob, charlie);
    ...
    #[test(aptos_framework = @0x1, dev = @dev, trust_16 = @trust_16, session_manager = @session_manager, alice = @0x111, bob = @0x222, charlie = @0x333)]
    public fun end_session(aptos_framework: &signer, dev: &signer, trust_16: &signer, session_manager: &signer, alice: &signer, bob: &signer, charlie: &signer) {
        test_utils::setup_test(aptos_framework, dev, trust_16, session_manager, alice, bob, charlie);
        let session_id = session::create_session(vector[signer::address_of(alice), signer::address_of(bob), signer::address_of(charlie)]);
