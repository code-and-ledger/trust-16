...
module trust_16::test_utils {
    ...
    public fun setup_test(aptos_framework: &signer, trust_16: &signer, alice: &signer, bob: &signer, charlie: &signer) {
    ...
    public fun setup_test_with_genesis(aptos_framework: &signer, trust_16: &signer, alice: &signer, bob: &signer, charlie: &signer) {
        genesis::setup();
        setup_test(aptos_framework, trust_16, alice, bob, charlie);
    }
}